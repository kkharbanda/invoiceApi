            ...
            <div class="search-result">
              ...
              <div class="search-item">
                <a href="#">
                  ...
                  </div>Create a new Homepage Design
                </a>
              </div>
            </div>
          </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li>
                  <a class="nav-link" href="modules-flag.html">Flag</a>
                </li>
                <li>
                  ...
                  <ul class="list-unstyled list-unstyled-border">
                    <li class="media">
                      ...
                      <div class="media-body">
                        ...
                        >Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin.</span>
                      </div>
                    </li>
                    <li class="media">
                      <img
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        <a href="#" class="dropdown-item has-icon">
                          <i class="far fa-circle"></i> Electronic
                        </a>
                        <a href="#" class="dropdown-item has-icon">
                          <i class="far fa-circle"></i> T-shirt
                        </a>
                        <a href="#" class="dropdown-item has-icon">
                          <i class="far fa-circle"></i> Hat
                        </a>
                        <div class="dropdown-divider"></div>
